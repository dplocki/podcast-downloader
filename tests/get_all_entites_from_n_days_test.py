...
class TestAllEntitiesFromNDays(unittest.TestCase):
    ...
    def test_of_filter_function(self):
        # Assign
        entity_future, entity_same_day, entity_older = rss_entity_generator(day=10, limit=3)
        ...
        # Act and Assert
        self.assertFalse(is_entity_newer(date, entity_older), "Older entity should be filter out")
        self.assertTrue(is_entity_newer(date, entity_same_day_1), "Same day entity (early hour) should be accepted")
        self.assertTrue(is_entity_newer(date, entity_same_day_2), "Same day entity (late hour) should be accepted")
        self.assertTrue(is_entity_newer(date, entity_future), "Newer entity should be accepted")
    ...
    def test_should_return_empty_collection(self):
        ...
        self.assertSequenceEqual(results, [], "The 'from date' was after all entities, the result should be empty")
    ...
    def test_should_return_filtered_collection(self):
        ...
        self.assertSequenceEqual(results, expected, "The 'from date' was before two entities")
