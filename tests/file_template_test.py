...
import unittest
from podcast_downloader.rss import RSSEntity, file_template_to_file_name, link_to_extension, link_to_file_name
...
class TestFileTemplateToFileNameConverter(unittest.TestCase):
    ...
    def test_link_to_extension(self):
        ...
        test_parameters = [
            ...
            ('http://www.podcast.com/podcast/something/Different_fIlE_nAme.mp3?asasasmkas&sdds', 'mp3'),
            ('http://www.podcast.com/podcast/something/multiple.dots.mp3', 'mp3'),
            ('http://www.podcast.com/podcast/something/multiple.dots.avi?with&parameter', 'avi'),
            ('http://www.podcast.com/podcast/something/normal_name.mp3?/with/tricky/para.meter', 'mp3'),
        ]
